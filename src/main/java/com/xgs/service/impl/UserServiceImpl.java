...
public class UserServiceImpl {
 ...
 public Map<String, String> getInfo(WechatLoginRequest wechatLoginRequest) throws HttpProcessException {
  ...
  public String getUUid(String openId) {
    UUID uuid = UUID.fromString(openId);
    stringRedisTemplate.opsForValue().set(uuid.toString(), openId);
